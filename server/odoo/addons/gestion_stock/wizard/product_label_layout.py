...
class ProductLabelLayout(models.TransientModel):
    ...
    product_ids = fields.Many2many('stock.produits')
    ...
    def _prepare_report_data(self):
        ...
        if self.print_format == 'dymo':
            xml_id = 'gestion_stock.report_product_template_label_dymo'
        elif 'x' in self.print_format:
            xml_id = 'gestion_stock.report_product_template_label'
        else:
            xml_id = ''
